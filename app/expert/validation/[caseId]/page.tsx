...
// CORRECTION TYPE: Extraction sécurisée du paramètre et fallback vers une chaine vide si undefined
...
// Gestion sécurisée des champs si useCase est null (évite crash au render initial)
...
if (!useCase) {
    return (
        <div className="text-center bg-white p-12 rounded-xl shadow-md">
            ...
            <p className="text-slate-600">Le cas avec l'ID "{caseId}" n'est plus dans la file d'attente ou n'existe pas.</p>
